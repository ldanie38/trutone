...
SECRET_KEY = 'django-insecure-ev_-0$)0lb^dfb6#6u43%++y!^h7b(vlch^pb__n7jq-xh4s^g'
...
# Optional: where Django looks for additional static files during development
STATICFILES_DIRS = [
    BASE_DIR / 'core' / 'static',        # adjust if your app static lives elsewhere
]
